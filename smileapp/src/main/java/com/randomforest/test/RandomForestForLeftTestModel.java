...
public class RandomForestForLeftTestModel {

	private static final String inputModel = "trainedModel\\left_trained.model";
	private static final String inputTest = "rowfiles/scaled_left_test.csv";

	public static Map<String, Object> getLeftRFPrediction(String inputTest, String inputModel) {
		Map<String, Object> mapVotesProb = null;
		try {
			// Load and Predict Model...
			System.out.println("Inside getLeftRFPrediction()======");
	...
	public static void main(String[] args) {
		try {
			...
			int[] testy = formula.y(testData).toIntArray();;
			int n = testData.size();
			Tuple xj = null;
			double[] posteriori = new double[n];
			Map<String, double[]> mapposteriori = new HashMap<String, double[]>();
